...
<head><!DOCTYPE html>
  <html dir="ltr" lang="en">
    ...
    <meta name="author" content="Ventiana Jelita"/>
    ...
    <title>Toko Online</title>
      ...
      <!-- Custom CSS -->
      <link rel="stylesheet"type="text/css"href="{{ asset('backend/matrix-admin/assets/extra-libs/multicheck/multicheck.css') }}" />
      <link href="{{ asset('backend/matrix-admin/assets/libs/datatables.net-bs4/css/dataTables.bootstrap4.css') }}"rel="stylesheet" />
            ...
            <div class="navbar-header" data-logobg="skin5">
              ...
              <a class="navbar-brand" href="index.html">
                ...
                <b class="logo-icon ps-2">
                  ...
                  <!-- Dark Logo icon -->
                  <img src="{{ asset('backend/image/image/icon_univ_bsi.png') }}" alt="homepage"
                ...
                <span class="logo-text ms-2">
                  <!-- dark Logo text -->
                  <img src="{{ asset('backend/image/image/logo_text.png') }}"  alt="homepage"
                    class="light-logo" />
                </span>
                <!-- Logo icon -->
                <!-- <b class="logo-icon"> -->
              ...
              <ul id="sidebarnav" class="pt-4">
                ...
                <li class="sidebar-item">
                  ...
                  <ul aria-expanded="false" class="collapse first-level">
                    <li class="sidebar-item">
                      <a href="icon-material.html" class="sidebar-link" ><i class="mdi 
                        mdi-emoticon"></i ><span 
                        class="hide-menu"> kategori </span></a>
                    </li>
                    <li class="sidebar-item">
                      <a href="icon-fontawesome.html" class="sidebar-link"  ><i class="mdi 
                        mdi-emoticon-cool"></i ><span 
        ...
        <div class="page-wrapper">
          ...
          <footer class="footer text-center">
           Web programming 2, Studi Kasus Toko Online
            <a href="https://www.instagram.com/vety_jelita">ventiana jelita</a>.
          </footer>
          <!-- ============================================================== -->
          <!-- End footer -->
          <!-- ============================================================== -->
