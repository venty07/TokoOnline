        ...
        <div class="auth-box bg-dark border-top border-secondary" style="width: 60vh">
          <div id="loginform">
            <div class="text-center pt-3 pb-3">
              <span class="db"
                ><img src="{{ asset('backend/image/image/logo_text.png') }}" alt="logo" /></span>
            </div>
              ...
              <div class="row pb-4">
                <div class="col-12">
                  <div class="input-group mb-3">
                    ...
                    <input type="text" name="email" class="form-control form-control-lg @error('email') is-invalid
                     is @enderror" placeholder="Masukkan Email" aria-label="Email" aria-describedby="basic-addon1"/>
                    @error('email')
